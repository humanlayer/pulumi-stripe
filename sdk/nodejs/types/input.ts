...
export interface CustomerCashBalance {
     ...
     */
    available?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
    /**
     ...
     */
    settings?: pulumi.Input<inputs.CustomerCashBalanceSettings>;
}
...
export interface CustomerCashBalanceSettings {
     ...
     */
    reconciliationMode?: pulumi.Input<string>;
}

export interface CustomerInvoiceSettings {
    customFields?: pulumi.Input<pulumi.Input<any[]>[]>;
    /**
     * ID of a payment method that's attached to the customer, to be used as the customer's default payment method for subscriptions and invoices.
     */
    defaultPaymentMethod?: pulumi.Input<string>;
    /**
     * Default footer to be displayed on invoices for this customer.
     */
    footer?: pulumi.Input<string>;
    renderingOptions?: pulumi.Input<inputs.CustomerInvoiceSettingsRenderingOptions>;
}
...
export interface CustomerInvoiceSettingsRenderingOptions {
     ...
     */
    amountTaxDisplay?: pulumi.Input<string>;
    /**
...
export interface CustomerTax {
     ...
     */
    automaticTax?: pulumi.Input<string>;
     ...
     */
    validateLocation?: pulumi.Input<string>;
}
...
export interface PriceCurrencyOption {
     ...
     */
    tiers?: pulumi.Input<pulumi.Input<any[]>[]>;
    /**
...
export interface PriceRecurring {
     ...
     */
    trialPeriodDays?: pulumi.Input<number>;
    /**
...
export interface PriceTier {
     ...
     */
    flatAmountDecimal?: pulumi.Input<string>;
    /**
...
export interface ProductDefaultPriceData {
     ...
     */
    currencyOptions?: pulumi.Input<pulumi.Input<inputs.ProductDefaultPriceDataCurrencyOption>[]>;
    /**
     * When set, provides configuration for the amount to be adjusted by the customer during Checkout Sessions and Payment Links.
     */
    customUnitAmount?: pulumi.Input<inputs.ProductDefaultPriceDataCustomUnitAmount>;
    /**
     * Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`.
     */
    metadata?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
     ...
     */
    recurring?: pulumi.Input<inputs.ProductDefaultPriceDataRecurring>;
    /**
     * Only required if a [default tax behavior](https://stripe.com/docs/tax/products-prices-tax-categories-tax-behavior#setting-a-default-tax-behavior-(recommended)) was not provided in the Stripe Tax settings. Specifies whether the price is considered inclusive of taxes or exclusive of taxes. One of `inclusive`, `exclusive`, or `unspecified`. Once specified as either `inclusive` or `exclusive`, it cannot be changed.
     */
    taxBehavior?: pulumi.Input<string>;
...
export interface ProductDefaultPriceDataCurrencyOption {
     ...
     * When set, provides configuration for the amount to be adjusted by the customer during Checkout Sessions and Payment Links.
     */
    customUnitAmount?: pulumi.Input<inputs.ProductDefaultPriceDataCurrencyOptionCustomUnitAmount>;
    key: pulumi.Input<string>;
    /**
     * Only required if a [default tax behavior](https://stripe.com/docs/tax/products-prices-tax-categories-tax-behavior#setting-a-default-tax-behavior-(recommended)) was not provided in the Stripe Tax settings. Specifies whether the price is considered inclusive of taxes or exclusive of taxes. One of `inclusive`, `exclusive`, or `unspecified`. Once specified as either `inclusive` or `exclusive`, it cannot be changed.
     */
...
export interface PromotionCodeRestrictions {
     ...
     */
    currencyOptions?: pulumi.Input<pulumi.Input<inputs.PromotionCodeRestrictionsCurrencyOption>[]>;
    /**
...
export interface V2BillingLicenseFeeTier {
     ...
     */
    flatAmount?: pulumi.Input<string>;
    /**
...
export interface V2BillingServiceActionCreditGrantAmount {
     ...
     */
    customPricingUnit?: pulumi.Input<inputs.V2BillingServiceActionCreditGrantAmountCustomPricingUnit>;
    /**
     * The monetary amount of the credit grant. Required if `type` is `monetary`.
     */
    monetary?: pulumi.Input<inputs.V2BillingServiceActionCreditGrantAmountMonetary>;
    /**
...
export interface V2BillingServiceActionCreditGrantApplicabilityConfigScope {
     ...
     */
    billableItems?: pulumi.Input<pulumi.Input<string>[]>;
    /**
...
export interface V2CoreEventDestinationAmazonEventbridge {
     ...
     */
    awsEventSourceArn?: pulumi.Input<string>;
    /**
     * The state of the AWS event source.
     */
    awsEventSourceStatus?: pulumi.Input<string>;
    /**
