module github.com/humanlayer/pulumi-stripe/provider

go 1.25.0

require (
	github.com/pulumi/pulumi-terraform-bridge/v3 v3.122.0
	github.com/stripe/terraform-provider-stripe v0.2.1
)
...
replace github.com/stripe/terraform-provider-stripe => ./shim
